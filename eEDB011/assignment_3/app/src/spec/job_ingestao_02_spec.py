...
class ETLJob:
    def __init__(self,
        ...
        self.path_output: str = "./app/data/output/spec/report_atividade_temp/"
    ...
    def transform(self, dataframes: dict) -> pl.DataFrame:
        ...
        temp_report_analitico = temp_report_analitico\
            .groupby("num_cnpj_instituicao", "ano", "num_trimestre")\
            .agg([
        ...
        dataframe = (temp_report_analitico
            .groupby(["nom_instituicao",
                      "num_cnpj_instituicao",
                      "nom_segto_instituicao",
                      "ano",
                      "num_trimestre"])
            .agg([
                pl.mean("qtd_totl_clie_css_scr").alias("max_qtd_totl_clie_ccs_scr"),
    ...
    def load(self, dataframe: pl.DataFrame) -> None:
        ...
        if not os.path.isdir(path_to_write):
            os.makedirs(path_to_write,
                        exist_ok=True)
        dataframe.write_csv(path_to_write+"tb_relatorio_final_temp.csv",
                            has_header=True,
                            separator=";")
